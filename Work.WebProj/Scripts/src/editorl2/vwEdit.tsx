            ...
            (
                <form className="form form-sm" onSubmit={this.callSubmit}>
                    ...
                    <div className="form-action">
                        ...
                        <button type="button" onClick={this.props.ajaxGridItem.bind(this, this.props.search) } className="btn btn-sm btn-secondary"><i className="fa-times"></i> {UIText.return}</button>
                        </div>
                    </div>
